...
class Page extends Compose(
	...
	add_main_section() {
		...
		this.add_view("main", 
			`<div class="layout-main">
				${!this.single_column?`<div class="layout-side-section"></div>`:''}
	...
	*/
	add_dropdown_item({label, click, standard, parent, shortcut, show_parent=true}) {
		if (show_parent) {
	...
	*/
	...
	set_title(txt, icon = '', stripHtml = true, tabTitle = '') {
		if(!txt) txt = "";
	...
	add_button(label, click, icon, is_title) {
		//
	}
